...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-877oyt8.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-877oyt8.containers.anotherwebservice.com/
...
```
git clone git@github.com:Secondyou/container-877oyt8.git
cd container-877oyt8
```
...
```
docker attach container-877oyt8
```
